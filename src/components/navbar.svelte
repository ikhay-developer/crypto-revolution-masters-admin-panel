...
<style scoped lang="less">
    .nav-not-xs() {
        ...
        button {
            ...
            span {
                color: white;
                display: var(--not-xs-span-display);
                font-size: 16.25px;
                margin-left: 10px;
            }
            &:nth-child(1) {
    ...
    nav {
        ...
        box-shadow: 0 2px 2px 0px #d6d6d6;
        display: flex;
        --not-xs-span-display: block;
        --sm-screen-width: 200px;
        --md-screen-width: 240px;
        --lg-screen-width: 280px;
        button {
