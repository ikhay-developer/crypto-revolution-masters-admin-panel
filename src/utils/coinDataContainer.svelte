<script lang="ts">
    ...
    export let is_add_to_favourite: boolean
    ...
    const addToFavourite = (e) => {
        if (!is_add_to_favourite && imageElement != null) {
            dispatcher("toadd", { x: imageElement.x + 2, y: imageElement.y - 50, name })
        }
    }
</script>
<div class="container">
    <div class="fixed-head">
        <p id="rank">
            <img bind:this={imageElement} on:click={addToFavourite} src={is_add_to_favourite ? "./img/star-fill.svg" : "./img/star.svg"} alt="star"> {market_cap_rank}
        </p>
        <p id="name">
